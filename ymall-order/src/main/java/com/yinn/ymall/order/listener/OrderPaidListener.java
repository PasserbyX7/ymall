...
@Service
@RocketMQMessageListener(topic = MQConstant.Order.TOPIC, consumerGroup = "order-"+MQConstant.Order.ORDER_PAID_CONSUMER_GROUP, selectorExpression = MQConstant.Order.TAG_PAID)
